...
const Hero = () => {
    return (
        <div className='w-full flex justify-center'>
            <div className='max-w-[350px] sm:max-w-screen-sm xl:max-w-screen-xl h-full'>
                <div className='w-full flex flex-col items-center'>
                    <h1 className='mt-14 sm:mt-20 max-w-[350px] sm:max-w-screen-sm xl:max-w-screen-lg text-3xl sm:text-5xl xl:text-7xl text-center font-bold capitalize bg-gradient-to-r from-cyan-500 to-purple-700 bg-clip-text text-transparent dark:opacity-90'>
